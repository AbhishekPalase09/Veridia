    ...
    <section id="contact" className="mb-28 scroll-mt-[120px]">
      <div className="grid md:grid-cols-2 gap-14 items-start">
        ...
        <div>
          ...
          <h2 className="mt-6 text-[48px] leading-[1.05] font-extrabold font-heading text-black">
        ...
        <div className="rounded-[22px] p-[2px] bg-gradient-to-b from-red-400 via-pink-400 to-purple-500">
          <div className="rounded-[20px] bg-white px-10 py-10">
            <h3 className="text-[32px] font-semibold mb-8 text-black font-inter">
              Send us your query
            </h3>
            ...
            <form onSubmit={onSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="text-[18px] leading-[150%] font-medium text-black">
                    Name
                  </label>
                  <input
                    name="name"
